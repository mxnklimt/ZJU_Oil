...
std::vector<uint8_t> dualAxisDeviceAddresses = { 0x0D };//RIGHT
#else
std::vector<uint8_t> adxl355DeviceAddresses = { 0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B };//现在0x04有了
...
//laser数据
std::vector<uint8_t>  laserDeviceAddresses= { 0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B};
